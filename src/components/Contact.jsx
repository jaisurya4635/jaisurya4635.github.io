  ...
  const contactItems = [
    {
      ...
      title: "Email",
      subtitle: "jaisuryajaisurya623@gmail.com",
      link: "mailto:jaisuryajaisurya623@gmail.com"
    },
    {
      icon: (
      ...
      link: "https://www.linkedin.com/in/jai-surya-b055a2339/"
    },
    {
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="#818cf8">
      ...
      link: "https://github.com/jaisurya4635"
    }
  ];
      ...
      <div className="container">
        ...
        <div className="contact-cards-grid">
          {contactItems.map((item, index) => (
            <a key={index} href={item.link} target={item.link.startsWith('mailto') ? '_self' : '_blank'} rel="noopener noreferrer" className="contact-card-dark">
        ...
        <p className="contact-availability">Available for new opportunities and interesting projects.</p>
      </div>
    </section>
  );
};
